...
This issue tracker is only for technical issues related to Loonie Core.
General LNI questions and/or support requests and are best directed to the [LNI Slack](http://loonie.slack.com).
...
### What version of Loonie Core are you using?
