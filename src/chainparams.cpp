...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 135; // LNI: 3 hours // 1 day
        nTargetSpacing = 1 * 135;  // LNI: 135 sec
        nLastPOWBlock = 750;
        nMaturity = 640;
        ...
        /*
        Z:\VMS\Gen\genquark>python genesis.py -a quark -z "Friday, July 12, 11:19 AM TIMEWARP Loonie 1505328322 150 Tonnen Fettberg verstopft Londons Kanalsystem" -n 2083236893 -t 1505328322 -v 0
        ...
        pszTimestamp: Friday, July 12, 11:19 AM TIMEWARP Loonie 1505328322 150 Tonnen Fettberg verstopft Londons Kanalsystem
        ...
        */
        ...
        const char* pszTimestamp = "Friday, July 12, 11:19 AM TIMEWARP Loonie 1505328322 150 Tonnen Fettberg verstopft Londons Kanalsystem";
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 135; // LNI: 1 day
        nTargetSpacing = 1 * 135;  // LNI: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
