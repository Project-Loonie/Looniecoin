...
Value getinfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total loonie balance of the wallet\n"
            "  \"mixTX_balance\": xxxxxx, (numeric) the anonymized loonie balance of the wallet\n"
    ...
    if (pwalletMain) {
        ...
        if (!fLiteMode)
            obj.push_back(Pair("mixTX_balance", ValueFromAmount(pwalletMain->GetAnonymizedBalance())));
    }
#endif
...
Value validateaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"loonieaddress\"\n"
            "\nReturn information about the given loonie address.\n"
            "\nArguments:\n"
            "1. \"loonieaddress\"     (string, required) The loonie address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"loonieaddress\", (string) The loonie address validated\n"
...
#ifdef ENABLE_WALLET
        // Case 1: LNI address and we have full public key:
