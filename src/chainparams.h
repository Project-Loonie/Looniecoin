 ...
 * LNI system. There are three: the main network on which people trade goods
...
public:
    ...
    std::string mixTXPoolDummyAddress() const { return strmixTXPoolDummyAddress; }
...
protected:
    ...
    std::string strmixTXPoolDummyAddress;
