...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& anonymizedBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
	...
	CAmount availableCredits = balance - immatureBalance;
   ...
   // ui->labelBalance->setText(BitcoinUnits::floorHtmlWithUnit(nDisplayUnit, balance - immatureBalance, false, BitcoinUnits::separatorAlways));
    ui->labelBalance->setText(BitcoinUnits::floorHtmlWithUnit(nDisplayUnit, availableCredits, false, BitcoinUnits::separatorAlways));
...
void OverviewPage::updatemixTXProgress()
{
    ...
    QString strAnonymizeLoonieAmount = BitcoinUnits::formatHtmlWithUnit(nDisplayUnit, nAnonymizeLoonieAmount * COIN, false, BitcoinUnits::separatorAlways);
    ...
    if (currentBalance == 0) {
        ...
        strAnonymizeLoonieAmount = strAnonymizeLoonieAmount.remove(strAnonymizeLoonieAmount.indexOf("."), BitcoinUnits::decimals(nDisplayUnit) + 1);
        strAmountAndRounds = strAnonymizeLoonieAmount + " / " + tr("%n Rounds", "", nmixTXRounds);
    ...
    if (nMaxToAnonymize > nAnonymizeLoonieAmount * COIN) nMaxToAnonymize = nAnonymizeLoonieAmount * COIN;

    if (nMaxToAnonymize == 0) return;

    if (nMaxToAnonymize >= nAnonymizeLoonieAmount * COIN) {
        ui->labelAmountRounds->setToolTip(tr("Found enough compatible inputs to anonymize %1")
                                              .arg(strAnonymizeLoonieAmount));
        strAnonymizeLoonieAmount = strAnonymizeLoonieAmount.remove(strAnonymizeLoonieAmount.indexOf("."), BitcoinUnits::decimals(nDisplayUnit) + 1);
        strAmountAndRounds = strAnonymizeLoonieAmount + " / " + tr("%n Rounds", "", nmixTXRounds);
    } else {
