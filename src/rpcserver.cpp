...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"loonie", "masternodelist", &masternodelist, true, true, false},
        {"loonie", "mnbudget", &mnbudget, true, true, false},
        {"loonie", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"loonie", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"loonie", "mnsync", &mnsync, true, true, false},
        {"loonie", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"loonie", "mixTX", &mixTX, false, false, true}, /* not threadSafe because of SendMoney */
		...
		{"wallet", "setchangeaddress", &setchangeaddress, true, false, true},
		{"wallet", "getchangeaddress", &getchangeaddress, true, false, true},
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use loonied, or the -server option to loonie-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:33448/\n";
}
