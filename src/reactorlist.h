...
//https://github.com/Project-Loonie/Loonie/blob/master/src/reactorlist.cpp

// the 10 Legendaries, no shutoff time. Filled with a unspendable (ghostcoins) Masternode collateral.
// a big thx to all our early supportes who made development of Loonie possible!
...
*/
    /* Koh-I-Noor.
     * Rough loonies may sometimes be mistaken for worthless pebbles, just like
...
*/
    /* The Sancy.
     * To grow a Loonie is a challenge but a good Loonie gains its value over
     * time. For every Loonie that makes my life a Bliss, a grateful THANKS!
