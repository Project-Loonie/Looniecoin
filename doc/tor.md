...
It is possible to run LNI as a Tor hidden service, and connect to such services.
...
Run LNI behind a Tor proxy
----------------------------------

The first step is running LNI behind a Tor proxy. This will already make all
...
HiddenServicePort 989 127.0.0.1:33447
...
your loonied's P2P listen port (33447 by default).
```
...
and open port 33447 on your firewall (or use -upnp).
