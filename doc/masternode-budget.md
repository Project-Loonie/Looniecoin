...
Loonie now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<loonie_address\> \<monthly_payment_loonie\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ LNI, _12_ times over the course of a year totaling _24000_ LNI.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<loonie_address\> \<monthly_payment_loonie\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` LNI.
